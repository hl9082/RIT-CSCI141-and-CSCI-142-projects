...
public class ToyLand {
    ...
    public void displayStatistics() {
        ...
        hapsum+=retiredToys.get(i).getHappiness();
        avg_wear+=retiredToys.get(i).getWear();
        System.out.println("\t"+retiredToys.get(i).toString());
        }
        avg_wear/=retiredToys.size();
        System.out.println("Total toys: "+retiredToys.size());
        System.out.println("Total happiness: "+hapsum);
        System.out.println("Average wear: "+avg_wear);
    }
