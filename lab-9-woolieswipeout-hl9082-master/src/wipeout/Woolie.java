...
public class Woolie extends Thread {
     ...
     * 10 (MAX_CROSSING_TIME), using the WoolieWipout.nextInt() method.
    ...
    public void run()  {
        ...
        //TODO
        this.preserver= Optional.ofNullable(this.kraken.getPreserver(this));
    for(int i=0;i<this.crossingTimeRemaining;i++){
        try{
            ...
            int chance=WoolieWipeout.nextInt(1,100);
                if(chance<=CHANCE_TO_FALL){
                    System.out.println("\tWOOLIE: "+this.toString()+"fell off the course!");
                    ...
                    System.out.println("\tWOOLIE: "+this.toString()+"crossing course...");
                    sleep(SLEEP_TIME);
